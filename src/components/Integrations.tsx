...
export function Integrations({ caseRecord }: { caseRecord?: IntegrationsRecord }) {
  const { t, tv } = useI18n();
  const currentIndex = caseRecord
    ? PHASE_ORDER.indexOf(CASE_STATE_DEFINITIONS[caseRecord.state as CaseState].phase)
    : -1;
